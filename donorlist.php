                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table dataTable my-0" id="dataTable">
                                    ...
                                    <?php 
                                            ...
                                            $sql = "SELECT * from users where isavail = 1" ;
                                    ...
                                    ?>
                                            ...
                                            <td>
                                                <form action="profileview.php" method="post">
                                                    ...
                                                    <button type = "submit" name="probut" class="btn btn-success">PROFILE</button>
                                            </form>
                                            </td>
                                            <!-- <td>
                                                <form action="includes/reqins.php" method="post">
                                                    <input type="hidden" name="reqto" value=<?php echo $row['username'];?>>
                                                    <input type="hidden" name="reqfrom" value=<?php echo $user_check;?>>
                                                    <button type = "submit" name="probut" class="btn btn-success">request</button>
                                            </form>
                                            </td> -->
                                        </tr>       
                                                <?php
                                                // echo "<tr><td>".$row["username"]."</td><td>".$row["age"]."</td><td>".$row["bloodgroup"]."</td><td>".$row["city"]."</td><td>".$row["state"]."</td><td>".$row["email"]."</td><td>".$row["phone"]."</td><tr>";
                                                }
                                                echo "</table>";
                                                }
                                                else{
