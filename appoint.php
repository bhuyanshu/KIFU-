                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table dataTable my-0" id="dataTable">
                                    ...
                                    <?php 
                                            ...
                                            $sql = "SELECT * from appointment where username = '$user_check'";
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                                <form action="includes/delapp.php" method="post">
                                                    ...
                                                    <button type = "submit" name="delete" class="btn btn-success">CANCEL</button>
                                            </form>
                                            </td>
                                        </tr>      
                                    <?php 
                                                // echo "<tr><td>".$row["id"]."</td><td>".$row["date"]."</td><td>".$row["time"]."</td><td>".$row["bg"]."</td><tr>";
                                                     }
                                                echo "</table>";
                                                }
                                            else{
