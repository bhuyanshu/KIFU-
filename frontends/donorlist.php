                ...
                <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
                    <div class="container-fluid d-flex flex-column p-0">
                        ...
                        <ul class="nav navbar-nav text-light" id="accordionSidebar">
                            ...
                            <li class="nav-item" role="presentation"><a class="nav-link active" href="">Bloodbanks</a></li>
                            ...
                            <li class="nav-item dropdown no-arrow" role="presentation">
                                <li class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#"><span class="d-none d-lg-inline mr-2 text-gray-600 small">#name</span></a>
                                    <div class="dropdown-menu shadow dropdown-menu-right animated--grow-in"
                                        ...
                                        <a
                                            class="dropdown-item" role="presentation" href="profile.php"><i class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i>&nbsp;Activity log</a>
