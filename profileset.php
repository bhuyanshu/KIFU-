                                        ...
                                        <div class="card-body">
                                            <form method="post" action = "includes/update.php" >
                                                <div class="form-row">
                                                    ...
                                                    <div class="col">
                                                        <div class="form-group"><label for="email"><strong>sex</strong></label><input class="form-control" type="text" placeholder="sex" name="sex" value=<?php echo $row['sex']; ?>></div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label for="first_name"><strong>Age</strong><br></label><input class="form-control" type="text" name="age" value=<?php echo $row['age']; ?>></div>
                                                    </div>
                                                    <div class="col">
